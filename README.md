...
```sh
gulp watch # strange phantom clicks/animations occuring possibly related to hot-module-replacment
gulp build -q # quick build with no uglify/minify, after run gulp browser-sync
gulp build # after run gulp browser-sync
```
...
#### Make it "Simple" with a Mixin
https://gist.github.com/dtothefp/506c658a297d4e9beacd
